        ...
        <div className='container'>
            ...
            className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
                ...
                <div className='p-6 sm:p-8'>
                    ...
                    <h1 data-aos='zoom-out' className='uppercase text-4xl lg:text-6xl font-bold'>
                        {" "}
                        {data.title}</h1>
                    <p data-aos='fade-up' className='text-sm py-2 mt-6'>{data.date}</p>
                </div>
                {/* second col */}
                ...
                <div className='flex flex-col justify-center gap-4 p-6 sm:p-8'>
                    ...
                    <div data-aos='fade-up' data-aos-offset='0'>
                        ...
                        className='bg-white py-2 px-4 rounded'>Compre Agora</button>
                    </div>
                </div>
            </div>
        </div>
